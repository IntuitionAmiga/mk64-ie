...
#ifdef IE_GFX_SVC
/* Second copy of the kart texture arena for the frame-parity double
 * buffer (see KART_TEXTURE_ARENA in buffers.h). */
ALIGNED8 union_D_802BFB80 D_802BFB80_svcAlt;
#endif
